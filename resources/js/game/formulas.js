 ...
 * Base: 100 XP, razão: 1.28× por nível (GDD Expansão 1.1).
 *
 * Referência de calibragem:
 *   Nv 5  → ~1.020 XP  | acumulado ~4.100
 *   Nv 10 → ~3.400 XP  | acumulado ~13.700
 *   Nv 15 → ~11.300 XP | acumulado ~46.200
 *   Nv 20 → ~37.900 XP | acumulado ~155.000
 *   Nv 25 → ~47.100 XP | acumulado ~168.000
 */
export const XP_BASE = 100;
export const XP_RATIO = 1.28;
...
/**
 * HP do Guardião da Torre baseado na base exponencial da Exploração.
 * Fórmula: HP_boss(zona=andar) × ratio(andar)
 */
...
/**
 * Dano do Guardião da Torre baseado na base exponencial da Exploração.
 * Fórmula: DMG_boss(zona=andar) × ratio(andar) × 0.6
 * (0.6 para manter dano proporcional — o HP é o gatekeeper principal)
 */
